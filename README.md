...
[![Projetos](https://img.shields.io/badge/Projetos-ver_os_cases-1A1A20?style=flat-square&logo=polywork&logoColor=A1A1AA&labelColor=0A0A0C)](https://leotino.dev/#projects)
...
<img
  alt="Stack: TypeScript, JavaScript, React, Next.js, Tailwind CSS, Sass, Node.js, NestJS, PHP, WordPress, GraphQL, PostgreSQL, MySQL, Redis, Prisma, Docker, NGINX, AWS, Cloudflare, Git, Bitbucket e Jest"
  src="https://skillicons.dev/icons?i=ts,js,react,nextjs,tailwind,sass,nodejs,nestjs,php,wordpress,graphql,postgres,mysql,redis,prisma,docker,nginx,aws,cloudflare,git,bitbucket,jest&theme=dark&perline=11"
/>
...
<img
  alt="Calendário de contribuições de Leonardo Tino renderizado como gráfico 3D isométrico"
  width="100%"
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     ...
     IMAGENS: coloque em /assets e use caminho relativo (ex.: assets/projeto-1.png).
              Recomendo 720×405 px (16:9), < 2 MB. Sem print, apague a <img>.
...
<img src="{{CAMINHO_DA_IMAGEM_1}}" alt="Captura de tela do projeto {{NOME_DO_PROJETO_1}}" width="100%" />
...
<div align="center">
  ...
  <img
    ...
    height="165"
    src="https://SEU-DEPLOY.vercel.app/api/top-langs/?username=ltin0&layout=compact&hide_border=true&langs_count=8&hide=html,css&bg_color=0A0A0C&title_color=4ADE80&text_color=A1A1AA"
  />
</div>
     ═══════════════════════════════════════════════════════════════════════════ -->
...
<sub>Se você tem uma vaga, uma ideia de produto ou um problema técnico que vale a pena resolver — me chama.</sub>
...
<img src="assets/wave.svg" alt="Faixa decorativa em degradê verde e violeta encerrando o perfil." width="100%" />
